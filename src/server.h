...
public:
	...
	*/
	...
	bool hudChange(RemotePlayer *player, u32 id, HudElementStat stat, void *value, u8 change_flags);
...
private:
	...
	void SendHUDChange(session_t peer_id, u32 id, HudElementStat stat, void *value, u8 change_flags);
